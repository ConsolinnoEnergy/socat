...
#ifndef __xio_hks3_h_included
#define __xio_hks3_h_included 1

#define SOCKS5_VERSION 5

#define SOCKS5_METHOD_SSL       0x86
...
struct socks5_method {
   uint8_t  version;
   uint8_t  nmethods;
   uint8_t  methods[0];		/* has variable length, see nmethods */
} ;
...
#endif /* !defined(__xio_hks3_h_included) */
